...
public class DateUtils {
	...
	private static long startupMilliseconds = System.currentTimeMillis();
  ...
  public static long getStartupTime()
    ...
    /** 
     * Returns true if the current time is between the supplied startTime and endTime hh:mm:ss
     */
    public static boolean isCurrentTimeBetween(String startTime, String endTime) throws Exception
    {
      ...
      String strnow = getCurrentTime("HH:mm");
      Date time3 = new SimpleDateFormat("HH:mm").parse(strnow);
      ...
      AgentLogger.logTrace("StartTime: " + calendar1.getTime());
      AgentLogger.logTrace("EndTime: " + calendar2.getTime());
      AgentLogger.logTrace("Now: " + calendar3.getTime());
     
      return now.after(calendar1.getTime()) && now.before(calendar2.getTime());
    }
