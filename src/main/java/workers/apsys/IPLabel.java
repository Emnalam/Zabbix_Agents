...
public class IPLabel extends Worker{
	...
	protected void doWork() throws Exception {
		...
		try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                AgentLogger.logUpdatesInfos("Entering extractanddisplaydata method");
                extractAndDisplayData(rawData);
                AgentLogger.logTrace("method executed");
                AgentLogger.logUpdatesInfos(" extractanddisplaydata method executed");
            } else {
    ...
    private void extractAndDisplayData(String rawData) throws Exception {
        ...
        AgentLogger.logUpdatesInfos(rowdata.toString());
        GlobalData.setDataList(rowdata);
        AgentLogger.logTrace(GlobalData.toString());
        AgentLogger.logUpdatesInfos(GlobalData.toString());
